...
export interface PluginMenusMenuItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    parent: Attribute.Relation<
      ...
      'plugin::menus.menu-item'
    >;
    example_bool: Attribute.Boolean;
    example_text: Attribute.String;
    example_email: Attribute.Email;
    example_password: Attribute.Password;
    example_richtext: Attribute.RichText;
    example_date: Attribute.Date;
    example_time: Attribute.Time;
    example_datetime: Attribute.DateTime;
    example_integer: Attribute.Integer;
    example_biginteger: Attribute.BigInteger;
    example_decimal: Attribute.Decimal;
    example_float: Attribute.Float;
    example_enum: Attribute.Enumeration<['option1', 'option2', 'option3']>;
    example_media: Attribute.Media;
    example_relation_one: Attribute.Relation<
      'plugin::menus.menu-item',
      'oneToOne',
      'api::page.page'
    >;
    example_relation_many: Attribute.Relation<
      'plugin::menus.menu-item',
      'oneToMany',
      'api::page.page'
    >;
...
export interface ApiContactPageContactPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    seo: Attribute.Component<'seo.meta-title'>;
...
export interface ApiGeneralSettingsStylingGeneralSettingsStyling
  extends Schema.SingleType {
  collectionName: 'general_settings_stylings';
  info: {
    singularName: 'general-settings-styling';
    pluralName: 'general-settings-stylings';
  ...
  attributes: {
    GeneralSettingsStyling: Attribute.Component<'options-panel.general-settings-styling'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::general-settings-styling.general-settings-styling',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    SiteName: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Strapi NextJs website'>;
    DefaultSeo: Attribute.Component<'seo.meta-title'> & Attribute.Required;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    SEO: Attribute.Component<'seo.meta-title'>;
    Hero: Attribute.Component<'hero.title'>;
    Title: Attribute.String;
    featuredImage: Attribute.Media;
    servicesPreview: Attribute.Component<'layout.services-preview'>;
    featuredJob: Attribute.Component<'layout.featured-job'>;
    postsSelection: Attribute.Component<'blog.posts-section'>;
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::job.job', 'oneToMany', 'api::tag.tag'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiMainMenuMainMenu extends Schema.SingleType {
  ...
  attributes: {
    MenuTab: Attribute.Component<'menu.menu-item', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiOptionsPanelGeneralSettingsStylingOptionsPanelGeneralSettingsStyling
  extends Schema.CollectionType {
  collectionName: 'options_panel_general_settings_stylings';
  info: {
    singularName: 'options-panel-general-settings-styling';
    pluralName: 'options-panel-general-settings-stylings';
    displayName: 'OptionsPanel-GeneralSettings-Styling';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::options-panel-general-settings-styling.options-panel-general-settings-styling',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    page: Attribute.Relation<'api::page.page', 'oneToOne', 'api::page.page'>;
...
export interface ApiServicesPageServicesPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::services-page.services-page', 'title'>;
    seo: Attribute.Component<'seo.meta-title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    servicesPreview: Attribute.Component<'blog.posts-section'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTeamMemberTeamMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    SocialLinks: Attribute.Component<'hero.link', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::general-settings-styling.general-settings-styling': ApiGeneralSettingsStylingGeneralSettingsStyling;
      ...
      'api::options-panel-general-settings-styling.options-panel-general-settings-styling': ApiOptionsPanelGeneralSettingsStylingOptionsPanelGeneralSettingsStyling;
