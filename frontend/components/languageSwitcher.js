    ...
    useEffect(() => {
        ...
        const checkLocaleMismatch = async () => {
            if (
                ...
                console.log('LANGUAGE SWICHER checkLocaleMismatch IF ===  localeCookie === ', localeCookie, 'pageContext === ', pageContext);
                ...
                console.log('LANGUAGE SWICHER checkLocaleMismatch ELSE === localeCookie === ', localeCookie, 'pageContext === ', pageContext);
                
                const localePage = await getLocalizedPage(
                    localeCookie,
                    pageContext
                ); // we then fetch the correct localized page
                //console.log('LANGUAGE SWICHER checkLocaleMismatch localePage === ', localePage);
            }
        };
